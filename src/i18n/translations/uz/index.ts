...
export const uzTranslations: TranslationSchema = {
  ...
  hero: {
    ...
    tooltip: {
      ...
      content:
        "Xitoyda o'qish haqida barcha ma'lumotlar shu yerda! Eng yaxshi universitetlar, grant dasturlari va boshqa imkoniyatlar haqida bilib oling",
    },
    cards: {
      scholarship: {
  ...
  comparison: {
    ...
    stories: {
      ...
      story1: {
        ...
        quote:
          "Xitoyda o'qish menga xalqaro darajadagi bilim va tajriba berdi. Bu muvaffaqiyatimning asosiy kaliti bo'ldi.",
      },
      story2: {
        name: 'Bobur Aliyev',
  ...
  whyChina: {
    ...
    subtitle:
      "Bu nafaqat diplom, balki butun dunyo tan oladigan tajriba",
  },
  success: {
    badge: 'Kelajak sari',
  ...
  special: {
    offer: {
      ...
      subtitle:
        "Xitoyda o'qishni boshlash uchun maxsus chegirmalar va bonuslar",
