...
export const enTranslations: TranslationSchema = {
  ...
  hero: {
    ...
    tooltip: {
      ...
      content:
        "Xitoyda o'qish bo'yicha to'liq ma'lumot. Bu yerda siz Xitoyning eng yaxshi universitetlarida o'qish imkoniyatlari, grant dasturlari va boshqa ko'plab qiziqarli ma'lumotlarni topishingiz mumkin. Bizning mutaxassislarimiz sizga to'g'ri yo'nalishni tanlashda yordam berishadi.",
    },
    cards: {
      scholarship: {
  ...
  comparison: {
    ...
    stories: {
      ...
      story1: {
        ...
        quote:
          "Xitoyda o'qish menga nafaqat sifatli ta'lim, balki butun dunyoda ishlash imkoniyatini berdi. Men o'rgangan tillar va aloqalar hozirgi karyeramda juda muhim rol o'ynaydi.",
      },
      story2: {
        name: 'Bobur Aliyev',
        ...
        quote:
          "Xitoyda olgan bilimlarim va tajribam o'z biznesimni boshlashda katta yordam berdi. Men o'rgangan innovatsion yondashuvlar biznesimni rivojlantirishda muhim ahamiyatga ega.",
      },
      story3: {
        ...
        quote:
          "Xitoyda o'qish davomida men nafaqat o'z sohamda chuqur bilim oldim, balki turli madaniyatlar bilan muloqot qilish ko'nikmalarini ham rivojlantirdim. Bu xalqaro karyeramda juda muhim.",
      },
    },
    education: {
  ...
  guarantees: {
    ...
    servicesDescription:
      "Biz sizning muvaffaqiyatli qabulingiz va qulay ta'lim olishingiz uchun to'liq xizmatlar kompleksini taqdim etamiz.",
    achievementsDescription:
      "Yillar davomida biz yuzlab talabalarga eng yaxshi universitetlarga kirish va o'z ta'lim maqsadlariga erishishda yordam berdik. Bizning statistikamiz o'z-o'zidan gapiradi.",
  ...
  special: {
    offer: {
      ...
      subtitle:
        "Biz sizning tanlagan universitetingizga kafolatli qabul qilinishingizni ta'minlaymiz va barcha bosqichlarda to'liq qo'llab-quvvatlaymiz",
  ...
  studentPath: {
    ...
    journey: {
      ...
      subtitle:
        "Biz sizni orzudan haqiqatga o'tish jarayonida har bir bosqichda qo'llab-quvvatlaymiz",
      exploration: {
        title: 'Tadqiqot',
