import "clsx";
import { g as getLangFromUrl, C as Card, S as Skeleton, a as SectionHeader, B as ButtonView } from "./ui_DFpIJiEG.mjs";
import { g as createCollectionToGlobResultMap, h as createReference, i as createGetCollection, c as createComponent, a as createAstro, e as renderComponent, d as renderTemplate, j as renderEntry } from "./vendor_BAzprikM.mjs";
import "kleur/colors";
...
import { H as Hand, C as Chevron_right } from "./icons_GFS7fkbb.mjs";
import fs from "fs";
...
async function getCachedData(key, fetchFn, ttl = 1e3 * 60 * 5) {
...
const $$UniversityFeature = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "UniversityCard", UniversityFeature, { "lang": lang, "universities": universities, "t": universityFeatureT, "client:visible": true, "client:component-hydration": "visible", "client:component-path": "/Users/komo1iddin/Desktop/AstroStudyLatest/project/src/components/features/university/UniversityFeature/UniversityFeature.svelte", "client:component-export": "default" })}`;
